...
#ifndef __MPlayer_h_h__
#define __MPlayer_h_h__
...
EXTERN_C const IID IID_IMMPlayer;
    ...
    public:
        ...
        virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE get_adTime( 
            /* [retval][out] */ int *pVal) = 0;
        
        virtual /* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE put_adTime( 
            /* [in] */ int newVal) = 0;
    ...
    typedef struct IMMPlayerVtbl
    {
        ...
        /* [helpstring][id][propget] */ HRESULT ( STDMETHODCALLTYPE *get_adTime )( 
            IMMPlayer * This,
            /* [retval][out] */ int *pVal);
        
        /* [helpstring][id][propput] */ HRESULT ( STDMETHODCALLTYPE *put_adTime )( 
            IMMPlayer * This,
            /* [in] */ int newVal);
...
#define IMMPlayer_get_image(This,pVal)	\
    ( (This)->lpVtbl -> get_image(This,pVal) ) 

#define IMMPlayer_put_image(This,newVal)	\
    ( (This)->lpVtbl -> put_image(This,newVal) ) 

#define IMMPlayer_get_adTime(This,pVal)	\
    ( (This)->lpVtbl -> get_adTime(This,pVal) ) 

#define IMMPlayer_put_adTime(This,newVal)	\
    ( (This)->lpVtbl -> put_adTime(This,newVal) ) 

#define IMMPlayer_get_speed(This,pVal)	\
    ( (This)->lpVtbl -> get_speed(This,pVal) ) 

#define IMMPlayer_put_speed(This,newVal)	\
