...
{     
    ...
    SendString(sock,"Accept-Language: zh-cn\r\n");     
    strcat(headerSend, "Accept-Language: zh-cn\r\n");     
    
    SendString(sock,"Accept-Encoding: gzip, default\r\n");     
	strcat(headerSend, "Accept-Encoding: gzip, default\r\n");   

	SendString(sock,"Referer: printf_fuck_you_or_me\r\n");
	strcat(headerSend,"Referer: printf_fuck_you_or_me\r\n");

	SendString(sock,"Proxy-Connection: Keep-Alive\r\n");
	strcat(headerSend,"Referer: printf_fuck_you_or_me\r\n");
	
    SendString(sock,"User-Agent: TTKVOD_SOFT_AGENT\r\n");     
    strcat(headerSend, "User-Agent: TTKVOD_SOFT_AGENT\r\n");     
