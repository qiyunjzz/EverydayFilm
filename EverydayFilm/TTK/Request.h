...
typedef struct { 
	LPSTR headerSend; 
	// Pointer to HTTP header Send  
	LPSTR headerReceive;       
	// Pointer to HTTP headers Receive  
    LPSTR message;                    
	// Pointer to the HTTP message    
	long messageLength;             
...
#endif 
// !defined(AFX_REQUEST_H__9F2C9BB6_CBA7_40AF_80A4_09A1CE1CE220__INCLUDED_) 